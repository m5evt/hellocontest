...
func setupLogbookView(builder *gtk.Builder) *logbookView {
	...
	result.view.AppendColumn(createColumn("Sent RST", columnMyReport))
	result.view.AppendColumn(createColumn("Sent Serial", columnMyNumber))
	result.view.AppendColumn(createColumn("Sent XChg", columnMyXchange))
	result.view.AppendColumn(createColumn("RST", columnTheirReport))
	result.view.AppendColumn(createColumn("Serial", columnTheirNumber))
	result.view.AppendColumn(createColumn("XChg", columnTheirXchange))
